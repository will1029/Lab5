...
public class ElasticsearchTweetController {
    ...
    // TODO we need a function which adds tweets to elastic search - Done
    ...
    // TODO we need a function which gets tweets from elastic search - Done
    public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<NormalTweet>> {
        ...
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) {
            ...
            ArrayList<NormalTweet> tweets = new ArrayList<NormalTweet>();
                ...
                // TODO Build the query - Done
            String query = "?q=message:this";
            ...
            try {
               // TODO get the results of the query - Done
